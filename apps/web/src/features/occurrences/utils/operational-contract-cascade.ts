 ...
 * Nome da executora só se a org atuante for a contractor; senão number/name do Contract.
 */
...
/** Fallback RLS só em 42501/FORBIDDEN. RPC [] com sucesso não entra aqui. */
export function shouldFallbackToRlsVisibleWorkspaceContracts(
  ...
  return isOperationalWorkspaceContractsForbidden(error);
}
