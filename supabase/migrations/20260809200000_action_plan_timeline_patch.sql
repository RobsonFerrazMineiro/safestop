-- ============================================================================
-- SafeStop — Sprint 3.0: Patch get_occurrence_timeline — kinds ACTION_*
-- ============================================================================
-- Referências: docs/decisions/ACTION-PLAN-DECISIONS.md; PO-CON-12 patch incremental
-- Base canônica: 20260808180000_ims_reference_rpcs.sql
-- ============================================================================

-- 1. Patch get_occurrence_timeline — kinds ACTION_* (Sprint 3.0)
-- ============================================================================
...
comment on function public.get_occurrence_timeline(uuid, jsonb, integer) is
  'Feed timeline unificado; VA + IO + MDHO + IMS + Plano de Ação (Sprint 3.0).';
