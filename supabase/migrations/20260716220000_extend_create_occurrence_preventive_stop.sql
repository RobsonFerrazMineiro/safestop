-- ============================================================================
-- SafeStop — Sprint 2.1: estender create_occurrence (Stop Work / PP)
-- ============================================================================
-- A-R2: contractor_organization_id obrigatório + vínculo contratual ativo
-- A-R4: stopped_at = occurred_at na criação
-- Status inicial inalterado: PARALISACAO_PREVENTIVA
-- Referência: docs/decisions/PREVENTIVE-STOP-DECISIONS.md
-- ============================================================================
...
comment on function public.create_occurrence(jsonb) is
  'Registra Paralisação Preventiva (Sprint 2.1): status PARALISACAO_PREVENTIVA, stopped_at=occurred_at, contractor_organization_id obrigatório com contrato ativo, public_code via contador global por ano (SS-{YY}-{NNNNNN}).';
